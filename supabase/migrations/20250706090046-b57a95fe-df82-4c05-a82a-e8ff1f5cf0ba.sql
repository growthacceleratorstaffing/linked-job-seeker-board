-- Create Workable OAuth and authentication system

-- First, create edge functions to handle Workable authentication and member sync
...
-- Update existing records to use correct roles
UPDATE workable_users SET workable_role = 'admin' WHERE workable_role = 'admin';
