    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All candidates from Workable and other sources</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12 text-muted-foreground">
            <Users className="mx-auto h-12 w-12 mb-4" />
            <h3 className="text-lg font-semibold mb-2">No Candidates Yet</h3>
            <p>Connect Workable integration to sync candidates or add them manually</p>
          </div>
        </CardContent>
      </Card>
    </div>
